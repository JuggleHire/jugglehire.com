...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      title: "Simplifying Hiring for Individuals and Small Businesses | useNiyog.com",
      htmlAttrs: { lang: "en" },
      meta: [
        { charset: "utf-8" },
        { name: "viewport", content: "width=device-width, initial-scale=1" },
        { hid: "description", name: "description",
          content: "Niyog is a recruitment software solution designed to simplify the hiring process. It's aimed at making the hiring journey easy and efficient for everyone.",
        },
