<template>
  <div class="bg-white ">
    ...
    <div class="relative isolate px-6 pt-[17rem] lg:px-8">
      ...
      <div class="mx-auto max-w-2xl py-30 ">
        ...
        <div class="text-center">
          ...
          <div class="mt-10 flex flex-col gap-2 items-center justify-center gap-x-6">
            <a href="#"
              class="rounded-md bg-blue-600 px-3.5 py-2.5 text-base inline-flex items-center justify-center gap-3 font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">14
            ...
            <span class="text-gray-600 text-sm">Start In A Minute. Cancel Anytime</span>
          </div>
