<template>
    <div class="bg-gray-900">
        <div class="relative isolate md:pt-14 pt-0">
            ...
            <div class="py-12 sm:py-32 lg:pb-40">
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="mx-auto max-w-3xl text-center">
                        ...
                        <p class="mt-6 sm:text-lg text-base sm:leading-8 text-gray-300">
            ...
            <div class="absolute inset-x-0 top-[calc(100%-23rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]"
                aria-hidden="true">
