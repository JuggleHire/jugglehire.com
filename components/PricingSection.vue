  ...
  <div class="bg-gray-900 py-16 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      ...
      <div class="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
        <div v-for="tier in tiers" :key="tier.id" :class="[tier.mostPopular ? 'bg-white/5 ring-2 ring-blue-500' : 'ring-1 ring-white/10', 'rounded-3xl sm:p-8 p-5 xl:p-10']">
          ...
          <p class="mt-6 flex items-baseline gap-x-1">
            <span class="sm:text-4xl text-3xl font-bold tracking-tight text-white">{{ tier.price[frequency.value] }}</span>
