  ...
  <div class="bg-gray-900">
    ...
    <div class="overflow-hidden relative isolate px-6 py-16 sm:py-40 lg:px-8">
      ...
      <div class="mx-auto max-w-2xl text-center">
        <h2 class="text-2xl font-bold tracking-tight text-white sm:text-4xl">Boost your productivity.<br />Start using JuggleHire app today.</h2>
        <p class="mx-auto mt-6 max-w-xl text-base sm:text-lg sm:leading-8 text-gray-300">
