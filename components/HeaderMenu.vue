<template>
  <header ref="headerRef"
    ...
    <Dialog as="div" class="lg:hidden" @close="mobileMenuOpen = false" :open="mobileMenuOpen">
      ...
      <DialogPanel
        class="fixed inset-y-0 right-0 z-[1000] w-full overflow-y-auto bg-gray-900 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-white/10">
            ...
            <template v-for="(nav, index) in navigation" :key="index">
              <Popover v-if="nav.items" class="relative z-50">
                ...
                <transition enter-active-class="transition ease-out duration-200"
                  ...
                  <PopoverPanel class="absolute left-1/2 z-[9999] flex w-full -translate-x-1/2 rounded-3xl bg-white">
                    <div
              ...
              <nuxt-link v-else :to="nav.href" class="text-sm font-semibold py-3 leading-6 text-white">{{ nav.name
                }}</nuxt-link>
            </template>
            <div class="py-6">
