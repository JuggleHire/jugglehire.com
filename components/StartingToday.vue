<template>
    <div class="relative bg-gray-900">
        <div class="relative h-80 overflow-hidden bg-indigo-400 md:absolute md:left-0 md:h-full md:w-1/3 lg:w-1/2">
        ...
        <div class="relative mx-auto max-w-7xl py-24 sm:py-28 lg:px-4 lg:py-30" data-aos="fade-up" data-aos-once="true">
            <div class="pl-6 pr-6 md:ml-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pl-24 lg:pr-0 xl:pl-32">
                ...
                <p class="text-base font-semibold leading-7 text-blue-500 mt-2">
                ...
                <div class="mt-8 flex items-center gap-4 flex-wrap lg:flex-nowrap">
                    <a href="https://app.jugglehire.com/register"
                        class="inline-flex items-center gap-2 rounded-md bg-blue-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">
