<template>
    <div class="bg-white py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div class="mx-auto mt-10 flex flex-wrap justify-center items-center gap-x-4 gap-y-3">
                <img v-for="client in clients" :key="client.name"
                    class="h-12 w-auto bg-white px-3 py-2 rounded object-contain" :src="client.logo" :alt="client.name"
                    width="158" height="48" />
            </div>
        </div>
    </div>
