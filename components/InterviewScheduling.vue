      ...
      <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
        <div class="lg:pr-8 lg:pt-4">
          <div class="lg:max-w-lg">
            <h2 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Simplest
        ...
        <img src="/simple-interview.png" alt="Product screenshot"
...
<script setup>
import { CalculatorIcon, ArrowUpOnSquareStackIcon, MegaphoneIcon } from '@heroicons/vue/20/solid'
...
const cardData = [
  {
    ...
    description: `Easily sync the calendar to double your interview booking and scheduling.`,
    icon: CalculatorIcon
  },
  {
    title: 'Stay Updated',
    description: `Set up automated notifications for both employers and candidates to stay informed.`,
    icon: ArrowUpOnSquareStackIcon
  },
  {
    title: 'Communication Tracking',
    description: `Track everything, from the beginning of the contact to the final feedback.`,
    icon: MegaphoneIcon
  },
]
</script>