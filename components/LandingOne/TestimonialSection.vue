<template>
    ...
    <div class="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <h2 class="mt-2 text-center text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Testimonial</h2>
        <!-- Blockquote -->
        <blockquote class="text-center lg:mx-auto lg:w-3/5">
            <div class="mt-6 lg:mt-10">
                <p class="relative text-xl sm:text-2xl md:text-3xl md:leading-normal font-medium text-gray-800">
                    ...
                    <span class="relative z-10 italic text-gray-800 dark:text-gray-200">I used to spend hours every week on recruitment tasks. Now, thanks to JuggleHire, I can focus on running my
                    business. The software is easy to use and has saved me so much time and money.</span>
                </p>
            </div>

            <footer class="mt-6">
                <div class="font-semibold text-gray-800 dark:text-gray-200">John Smith</div>
                <div class="text-sm text-gray-500">CEO of XYZ Company</div>
            </footer>
        </blockquote>
        <!-- End Blockquote -->
        <div
