<template>
    <div class="relative isolate bg-white pb-32 pt-24 sm:pt-32 border-t border-gray-100">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl sm:text-center">
                    <h2 class="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-4xl">Master At Hiring
                        Talents</h2>
                    <p class="mt-6 sm:text-lg text-base sm:leading-8 text-gray-600">Become More Fluent Starting From
                        Scratch</p>
                </div>
            </div>
                ...
                <div
                    ...
                    <div class="lg:pr-8 lg:pt-4">
                        <div class="lg:max-w-lg">
                            <h2 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Master At Hiring Talents
                            </h2>
                            <p class="mt-6 text-lg leading-8 text-gray-800">Become More Fluent Starting From Scratch</p>
                            <dl class="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
                                <div class="relative pl-9">
                                    ...
                                    <dd class="inline">Stop small business requirements nightmare</dd>
                                    <p class="mt-2">
                                        <a href="#" class="text-sm font-semibold leading-6 text-blue-600">Learn more <span aria-hidden="true">→</span></a>
                                    </p>
                                </div>
                                <div class="relative pl-9">
                                    <dt class="inline font-semibold text-gray-900">
                                        <svg class="absolute left-1 top-1 h-5 w-5 text-blue-600" viewBox="0 0 20 20"
                                    ...
                                    <dd class="inline">Virtually get your team members to keep coming</dd>
                                    <p class="mt-2">
                                        <a href="#" class="text-sm font-semibold leading-6 text-blue-600">Learn more <span aria-hidden="true">→</span></a>
                                    </p>
                                </div>
                                <div class="relative pl-9">
                                    ...
                                    <dd class="inline">Hire talent like the snap of a finger</dd>
                                    <p class="mt-2">
                                        <a href="#" class="text-sm font-semibold leading-6 text-blue-600">Learn more <span aria-hidden="true">→</span></a>
                                    </p>
                                </div>
