        ...
        <div class="lg:pr-4">
          <div class="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
            ...
            <div class="absolute left-1/2 top-1/2 -ml-16 -translate-x-1/2 -translate-y-1/2 transform-gpu blur-3xl" aria-hidden="true">
              <div class="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr from-[#ffffff] to-[#2563eb] opacity-40" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)" />
            </div>
            <figure class="relative isolate">
              ...
              <img src="/clients/lomeyo.svg" alt="" class="h-12 w-auto" />
              <blockquote class="mt-6 text-xl font-semibold leading-8 text-white">
                <p>“JuggleHire is not just about hiring; it's about simplifying the journey of bringing great minds together. It's our commitment to turning recruitment into a delightful adventure”</p>
              </blockquote>
              <figcaption class="mt-6 text-sm leading-6 text-gray-300"><strong class="font-semibold text-white">Zakir Hossen,</strong> CEO at JuggleHire</figcaption>
            </figure>
          </div>
        </div>
        <div>
...
const title = "About JuggleHire | Our Story, Mission, and Vision";
const description = "Learn about JuggleHire and discover our story, mission, and vision. Find out how we're revolutionizing small business hiring.";
